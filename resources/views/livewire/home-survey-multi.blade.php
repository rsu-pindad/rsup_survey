    ...
    <header class="mb-2">
        <div>
            <a href="#" class="float-md-start mb-0 navbar-brand py-3 d-none d-xs-none d-sm-none d-md-block">
                <img class="d-inline-block align-text-top img-thumbnail" src="{{ basset('photos/'.$subLogo ?? 'default_domain.png') }}" alt="logo" width="160px" height="60px">
            </a>
    ...
    <main class="px-2">
        <div class="d-flex flex-row justify-content-center">
            ...
            <ul class="list-group list-group-horizontal">
                ...
                <li wire:key="{{ $item->id }}" wire:click="$dispatch('show-layanan', {id: {{ $item->layanan_id }} })" id="items{{ $item->layanan_id }}" class="mx-2 border border-2 rounded-4 list-group-item {{ $this->selectedLayananId == $item->layanan_id ? 'active' : '' }}" style="max-width: min-content;
                        cursor:pointer;">
        ...
        @if ($setLayanan)
        <div class="d-flex flex-col justify-content-center rainbow" style="overflow-x: overlay;
            scroll-behavior:smooth;
            scrollbar-width:none;">
            <ul class="list-group list-group-horizontal py-3">
                @foreach ($this->listRespon as $item)
                <li wire:key="{{ $item->id }}" wire:click="$dispatch('pre-save', {id: {{ $item->id }} })" class="mx-4 border border-2 rounded-4 list-group-item btn-custom li-custom" style="width: 180px; height:220px;
                            ...
                            <form class="mt-2">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="input-group has-validation">
                                            ...
                                            <div class="form-floating @error('namaPasien') is-invalid @enderror">
                                                <input wire:model.defer="namaPasien" type="text" class="form-control @error('namaPasien') is-invalid @enderror" id="namaPasien" placeholder="Nama Anda">
                                ...
                                <div class="d-flex flex-row justify-content-center">
                                    <div class="align-self-center p-2">
                                        <button wire:click="saveModal" type="button" class="btn btn-primary">
                                            Selesai
                                        </button>
                                    </div>
                                    <div class="align-self-center p-2">
